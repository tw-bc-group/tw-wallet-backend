...
public class TblIssuersRecord extends UpdatableRecordImpl<TblIssuersRecord> implements Record2<String, String> {

    private static final long serialVersionUID = -506512947;

    /**
     * Setter for <code>public.tbl_issuers.id</code>.
     */
    public TblIssuersRecord setId(String value) {
        set(0, value);
        return this;
    }
    ...
    @Override
    public TblIssuersRecord value1(String value) {
        setId(value);
        return this;
    }
    ...
    @Override
    public TblIssuersRecord values(String value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public TblIssuersRecord(String id, String name) {
        super(TblIssuers.TBL_ISSUERS);
