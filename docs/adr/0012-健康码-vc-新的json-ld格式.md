...
原来的健康码是基于jwt格式，参考《健康认证的技术方案》，关键payload这样
...
使用新定义的上下文词汇，现在改进的VC格式，用json-ld表示：
```json
...
```json
{
  "@context": {
    ...
    "ImmunoglobulinDetectionTestCard": {
      "@id": "https://w3c-ccg.github.io/vc-examples/covid-19/v1/v1#ImmunoglobulinDetectionTestCard",
      "@context": {
        "@version": 1.1,
        "@protected": true,
        "id": "@id",
    ...
    "ImmunoglobulinDetectionTestSubject": {
      "@id": "https://w3c-ccg.github.io/vc-examples/covid-19/v1/v1#ImmunoglobulinDetectionTestSubject",
      "@context": {
        "@version": 1.1,
        "@protected": true,
        "id": "@id",
        "type": "@type",
        "covid-19": "https://w3c-ccg.github.io/vc-examples/covid-19/v1/v1#",
...
此VC是V1版本的新冠检测，可以用来模拟过时的VC，verifier不接受
