...
public class TblVcTypesRecord extends UpdatableRecordImpl<TblVcTypesRecord> implements Record4<Integer, String, Integer, String[]> {

    private static final long serialVersionUID = -1097483546;

    /**
     * Setter for <code>public.tbl_vc_types.id</code>.
     */
    public TblVcTypesRecord setId(Integer value) {
        set(0, value);
        return this;
    }
    ...
    @Override
    public TblVcTypesRecord value1(Integer value) {
        setId(value);
        return this;
    }
    ...
    @Override
    public TblVcTypesRecord values(Integer value1, String value2, Integer value3, String[] value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TblVcTypesRecord(Integer id, String name, Integer issuer, String[] content) {
        super(TblVcTypes.TBL_VC_TYPES);
